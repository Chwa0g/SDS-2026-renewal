//헤더 gnb 삽입       
$.get('/kr/gnb/gkr01/menu.html?queryString=20260720045245', function(data) {
			$('#mega-menu').empty();
...
//우측 플로팅 삽입       
$.get('/kr/layout/floating-action-v2.html?queryString=20260720045245', function(data) {
            $('#floating-menu').append(data);
        });


// 푸터 삽입 시작
   // $("#footer").load("/kr/layout/footer.html?queryString=20260720045245", footerInit);
 $.get('/kr/layout/footer.html?queryString=20260720045245', function(data) {
            $('#footer').append(data);
        });
