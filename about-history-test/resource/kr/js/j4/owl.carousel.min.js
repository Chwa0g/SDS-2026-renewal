    ...
    function (a, b, c) {
            ...
            this.core = b,
                ...
                this.handlers = {
                    ...
                    "mouseover.owl.autoplay": a.proxy(function () {
                        this.core && this.core.settings && this.core.settings.autoplayHoverPause && this.pause()
                    }, this),
                    "mouseleave.owl.autoplay": a.proxy(function () {
                        this.core && this.core.settings && this.core.settings.autoplayHoverPause && this.autoplay()
                    }, this)
                },
                this.core.$element.on(this.handlers)
        };
        d.Defaults = {
            ...
            d.prototype.autoplay = function () {
                this.core && this.core.settings && this.core.settings.autoplay && !this.core.state.videoPlay ? (b.clearInterval(this.interval),
            ...
            d.prototype.play = function () {
                return c.hidden === !0 || !this.core || !this.core.state || this.core.state.isTouch || this.core.state.isScrolling || this.core.state.isSwiping || this.core.state.inMotion ? void 0 : !this.core.settings || this.core.settings.autoplay === !1 ? void b.clearInterval(this.interval) : void this.core.next(this.core.settings.autoplaySpeed)
            }
            ,
            d.prototype.stop = function () {
            ...
            d.prototype.destroy = function () {
                ...
                b.clearInterval(this.interval);
                for (a in this.handlers)
                    this.core && this.core.$element && this.core.$element.off(a, this.handlers[a]);
    ...
    function (a) {
        ...
        b.Defaults = {
            ...
            b.prototype.initialize = function () {
                ...
                d.dotsData || (this._templates = [a("<div>").addClass(d.dotClass).append(a("<a class='ind' href='#'   tabindex='0'>1번")).prop("outerHTML")]),
